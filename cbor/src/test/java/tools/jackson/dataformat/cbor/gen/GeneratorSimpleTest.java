...
public class GeneratorSimpleTest extends CBORTestBase
{
    ...
    public void testSimpleBigIntegerEncoding() throws Exception
    {
        ...
        try (JsonGenerator gen1 = factory.createGenerator(ObjectWriteContext.empty(),
                correctOut)) {
        ...
        factory = CBORFactory.builder()
                .disable(CBORWriteFeature.ENCODE_USING_STANDARD_NEGATIVE_BIGINT_ENCODING)
                .build();
        try (JsonGenerator gen2 = factory.createGenerator(ObjectWriteContext.empty(),
                incorrectOut)) {
